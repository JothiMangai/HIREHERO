...
image_path = "C:/Users/Jothi/OneDrive/Desktop/MINIPROJECT/Images/logo.png"
...
Resumes = pd.read_csv('C:/Users/Jothi/OneDrive/Desktop/MINIPROJECT/Demo/Resume_Data.csv')
Jobs = pd.read_csv('C:/Users/Jothi/OneDrive/Desktop/MINIPROJECT/Demo/Job_Data.csv')
...
def calculate_scores(resumes, job_descriptions):
    ...
    for x in range(resumes.shape[0]):
        score = Similar.match(
            resumes['TF_Based'][x], job_descriptions['TF_Based'][index])
        scores.append(score)
    return scores
